...
class LiveTrackingPage extends StatefulWidget {
  ...
  final List<LatLng>? routePoints; // Puntos de la ruta del bus
...
class _LiveTrackingPageState extends State<LiveTrackingPage> {
  ...
  void _initializeMap() {
    // Usar ubicación de origen si está disponible, si no usar posición inicial
    final LatLng userPosition = (widget.originLat != null && widget.originLng != null)
        ? LatLng(widget.originLat!, widget.originLng!)
        : _initialPosition;

    // Usar ubicación de destino si está disponible
    final LatLng? destinationPosition = (widget.destinationLat != null && widget.destinationLng != null)
    ...
    // Marcador del destino (si está disponible)
    ...
    // Ruta del bus: si hay puntos de ruta, usarlos; si no, usar línea recta
    if (widget.routePoints != null && widget.routePoints!.isNotEmpty) {
      ...
      // Fallback a línea recta si no hay puntos de ruta
      _polylines.add(
        Polyline(
          polylineId: const PolylineId('bus_route'),
          points: [
            ...
            destinationPosition ?? const LatLng(-16.400, -71.530),
          ],
          color: AppColors.primary,
          width: 5,
        ),
